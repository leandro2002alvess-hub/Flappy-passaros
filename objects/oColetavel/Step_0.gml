...
//Criando um efeito para depois destruir meu objeto

 if(foi_pego == true) 
{
    image_xscale -= 0.1
    image_yscale += 0.1
    tempo_coletavel_crescimento++
    if(tempo_coletavel_crescimento >= tempo_coletavel_crescimento_limite) 
    {
        instance_destroy()
        //show_message("Destruido")
        tempo_coletavel_crescimento = 0
    }
